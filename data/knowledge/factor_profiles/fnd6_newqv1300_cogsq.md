...
direction_gap: -0.36
---
# fnd6_newqv1300_cogsq (fundamental6)

*Cost of Goods Sold*

## Signal Profile
- `rank(fnd6_newqv1300_cogsq)`: S=0.87, F=0.76, T=1.3%, INFERIOR (TOP3000)
- `rank(fnd6_newqv1300_cogsq / close)`: S=1.22, F=1.05, T=1.7%, AVERAGE (TOP3000)
- `rank(ts_delta(fnd6_newqv1300_cogsq, 5))`: S=-0.04, F=0.00, T=38.0%, INFERIOR (TOP500)
- `-rank(fnd6_newqv1300_cogsq)`: S=-0.42, F=-0.27, T=2.0%, INFERIOR (TOP3000)
- `rank(-1 * ts_delta(fnd6_newqv1300_cogsq, 5))`: S=0.86, F=0.30, T=37.6%, INFERIOR (TOP3000)
- `-ts_zscore(fnd6_newqv1300_cogsq, 63)`: S=-0.09, F=-0.01, T=18.9%, INFERIOR (TOP3000)
- `ts_mean(fnd6_newqv1300_cogsq, 10)`: S=0.17, F=0.06, T=1.4%, INFERIOR (TOP3000)
- `rank(ts_rank(fnd6_newqv1300_cogsq, 22))`: S=-0.07, F=-0.01, T=17.0%, INFERIOR (TOP3000)
- `rank(-1 * fnd6_newqv1300_cogsq)`: S=-0.87, F=-0.76, T=1.3%, INFERIOR (TOP3000)
- `rank(-1 * fnd6_newqv1300_cogsq / close)`: S=-1.22, F=-1.05, T=1.7%, INFERIOR (TOP3000)
...
## Negated Direction
Best negated: `rank(-1 * ts_delta(fnd6_newqv1300_cogsq, 5))` S=0.86, F=0.30, INFERIOR
...
|---|---|---|---|---|---|---|
| `rank(fnd6_newqv1300_cogsq / close)` | TOP3000 | 1.21 | 1.05 | 7.8% | 100% | bull-only |
| `rank(fnd6_newqv1300_cogsq)` | TOP3000 | 0.86 | 0.76 | 27.3% | 80% | bull-only |
| `rank(fnd6_newqv1300_cogsq / close)` | TOP1000 | 0.73 | 0.55 | 11.4% | 100% | bull-only |
| `rank(fnd6_newqv1300_cogsq / close)` | TOP500 | 0.56 | 0.37 | 16.6% | 60% | bull-only |
| `rank(fnd6_newqv1300_cogsq)` | TOP1000 | 0.41 | 0.27 | 30.5% | 60% | bull-only |
| `rank(fnd6_newqv1300_cogsq)` | TOP500 | 0.24 | 0.12 | 33.5% | 60% | bull-only |
