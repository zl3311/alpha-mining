...
field: ts_decay_linear(zscore(ts_mean(implied_volatility_call_60 - implied_volatility_put_60,
  66)) + rank(max_adjusted_net_income_guidance) + rank(anl4_bvps_flag), 5)
dataset: unknown
...
n_sims: 1
---
# ts_decay_linear(zscore(ts_mean(implied_volatility_call_60 - implied_volatility_put_60, 66)) + rank(max_adjusted_net_income_guidance) + rank(anl4_bvps_flag), 5) (unknown)
