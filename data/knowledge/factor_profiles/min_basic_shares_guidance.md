---
field: min_basic_shares_guidance
dataset: analyst4
...
direction_gap: -0.42
---
# min_basic_shares_guidance (analyst4)

*Shares Basic - Minimum guidance value*

## Signal Profile
- `rank(min_basic_shares_guidance)`: S=0.51, F=0.35, T=2.4%, INFERIOR (TOP3000)
- `rank(min_basic_shares_guidance / close)`: S=0.07, F=0.02, T=1.6%, INFERIOR (TOP3000)
- `rank(ts_delta(min_basic_shares_guidance, 5))`: S=0.60, F=0.53, T=21.3%, INFERIOR (TOP3000)
- `-rank(min_basic_shares_guidance)`: S=-0.04, F=-0.01, T=2.9%, INFERIOR (TOP3000)
- `rank(-1 * ts_delta(min_basic_shares_guidance, 5))`: S=0.83, F=0.88, T=11.2%, INFERIOR (TOP3000)
- `-ts_zscore(min_basic_shares_guidance, 63)`: S=-0.60, F=-0.52, T=2.1%, INFERIOR (TOP3000)
- `ts_mean(min_basic_shares_guidance, 10)`: S=-0.31, F=-0.23, T=14.3%, INFERIOR (TOP3000)
- `rank(ts_rank(min_basic_shares_guidance, 22))`: S=1.25, F=1.82, T=11.5%, GOOD (TOP3000)
- `rank(-1 * min_basic_shares_guidance)`: S=0.50, F=0.33, T=3.2%, INFERIOR (TOP3000)
- `rank(-1 * min_basic_shares_guidance / close)`: S=0.06, F=0.01, T=2.3%, INFERIOR (TOP3000)
...
## Negated Direction
Best negated: `rank(-1 * ts_delta(min_basic_shares_guidance, 5))` S=0.83, F=0.88, INFERIOR
...
|---|---|---|---|---|---|---|
| `rank(ts_delta(min_basic_shares_guidance, 5))` | TOP3000 | 0.62 | 0.53 | 70.3% | 80% | mixed |
| `rank(min_basic_shares_guidance)` | TOP3000 | 0.48 | 0.35 | 37.6% | 40% | bull-only |
| `rank(min_basic_shares_guidance)` | TOP500 | 0.47 | 0.33 | 32.4% | 60% | bull-only |
| `rank(min_basic_shares_guidance)` | TOP200 | 0.15 | 0.07 | 30.7% | 60% | bull-only |
| `rank(min_basic_shares_guidance / close)` | TOP3000 | 0.07 | 0.02 | 53.4% | 60% | bull-only |
