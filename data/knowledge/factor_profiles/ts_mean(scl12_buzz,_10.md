...
n_sims: 1
---
# ts_mean(scl12_buzz, 10 (unknown)


## Signal Profile
- `ts_decay_linear(rank(ts_mean(scl12_buzz, 10)) * zscore(ts_mean(implied_volatility_call_270 - implied_volatility_put_270, 22)), 5)`: S=1.87, F=2.81, T=7.5%, SPECTACULAR (TOP3000)
