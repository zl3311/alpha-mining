---
field: ts_sum(anl4_totassets_flag, 22
dataset: unknown
...
n_sims: 1
---
# ts_sum(anl4_totassets_flag, 22 (unknown)


## Signal Profile
- `ts_decay_linear(rank(ts_sum(anl4_totassets_flag, 22)), 5)`: S=1.67, F=1.73, T=4.1%, GOOD (TOP3000)
