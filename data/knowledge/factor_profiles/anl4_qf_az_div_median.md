...
direction_gap: 0.1
---
# anl4_qf_az_div_median (analyst4)

*Dividend per share - median of estimations*

## Signal Profile
- `rank(anl4_qf_az_div_median)`: S=-0.09, F=-0.02, T=1.3%, INFERIOR (TOP1000)
- `rank(anl4_qf_az_div_median / close)`: S=0.46, F=0.25, T=1.9%, INFERIOR (TOP1000)
- `rank(ts_delta(anl4_qf_az_div_median, 5))`: S=0.50, F=0.16, T=34.6%, INFERIOR (TOP500)
- `-rank(anl4_qf_az_div_median)`: S=0.09, F=0.02, T=1.3%, INFERIOR (TOP3000)
- `rank(-1 * ts_delta(anl4_qf_az_div_median, 5))`: S=0.16, F=0.04, T=33.0%, INFERIOR (TOP3000)
- `-ts_zscore(anl4_qf_az_div_median, 63)`: S=0.28, F=0.08, T=19.9%, INFERIOR (TOP3000)
- `ts_mean(anl4_qf_az_div_median, 10)`: S=0.11, F=0.03, T=1.2%, INFERIOR (TOP3000)
- `rank(ts_rank(anl4_qf_az_div_median, 22))`: S=0.18, F=0.04, T=13.4%, INFERIOR (TOP3000)
- `rank(-1 * anl4_qf_az_div_median)`: S=0.51, F=0.32, T=2.0%, INFERIOR (TOP3000)
- `rank(-1 * anl4_qf_az_div_median / close)`: S=0.56, F=0.40, T=2.6%, INFERIOR (TOP3000)
...
## Negated Direction
Best negated: `rank(-1 * anl4_qf_az_div_median / close)` S=0.56, F=0.40, INFERIOR
...
|---|---|---|---|---|---|---|
| `rank(anl4_qf_az_div_median / close)` | TOP1000 | 0.44 | 0.25 | 9.8% | 60% | bull-only |
| `rank(anl4_qf_az_div_median / close)` | TOP3000 | 0.41 | 0.20 | 9.6% | 60% | bull-only |
| `rank(ts_delta(anl4_qf_az_div_median, 5))` | TOP500 | 0.50 | 0.16 | 13.7% | 80% | mixed |
| `rank(ts_delta(anl4_qf_az_div_median, 5))` | TOP3000 | 0.30 | 0.06 | 12.1% | 60% | mixed |
