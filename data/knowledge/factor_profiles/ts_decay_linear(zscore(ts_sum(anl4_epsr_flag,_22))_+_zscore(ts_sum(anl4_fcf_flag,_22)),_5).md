---
field: ts_decay_linear(zscore(ts_sum(anl4_epsr_flag, 22)) + zscore(ts_sum(anl4_fcf_flag,
  22)), 5)
dataset: unknown
...
n_sims: 1
---
# ts_decay_linear(zscore(ts_sum(anl4_epsr_flag, 22)) + zscore(ts_sum(anl4_fcf_flag, 22)), 5) (unknown)
