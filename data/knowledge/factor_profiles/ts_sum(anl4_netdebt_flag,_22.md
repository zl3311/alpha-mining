---
field: ts_sum(anl4_netdebt_flag, 22
dataset: unknown
...
n_sims: 1
---
# ts_sum(anl4_netdebt_flag, 22 (unknown)


## Signal Profile
- `ts_decay_linear(rank(ts_sum(anl4_netdebt_flag, 22)), 5)`: S=1.65, F=1.52, T=2.3%, GOOD (TOP3000)
