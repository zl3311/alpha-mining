...
direction_gap: -0.74
---
# anl4_qfd1_azeps (analyst4)

*EPS - aggregation on estimations, 50th percentile*

## Signal Profile
- `rank(anl4_qfd1_azeps)`: S=0.40, F=0.25, T=1.2%, INFERIOR (TOP3000)
- `rank(anl4_qfd1_azeps / close)`: S=0.90, F=0.74, T=2.2%, INFERIOR (TOP3000)
- `rank(ts_delta(anl4_qfd1_azeps, 5))`: S=0.41, F=0.09, T=36.7%, INFERIOR (TOP1000)
- `-rank(anl4_qfd1_azeps)`: S=-0.16, F=-0.06, T=1.7%, INFERIOR (TOP3000)
- `rank(-1 * ts_delta(anl4_qfd1_azeps, 5))`: S=0.16, F=0.03, T=36.9%, INFERIOR (TOP3000)
- `ts_zscore(anl4_qfd1_azeps, 22)`: S=0.24, F=0.05, T=33.7%, INFERIOR (TOP3000)
- `ts_mean(anl4_qfd1_azeps, 10)`: S=-0.10, F=-0.03, T=1.1%, INFERIOR (TOP3000)
- `rank(ts_rank(anl4_qfd1_azeps, 22))`: S=0.08, F=0.01, T=14.3%, INFERIOR (TOP3000)
- `rank(-1 * anl4_qfd1_azeps)`: S=-0.08, F=-0.02, T=2.1%, INFERIOR (TOP3000)
- `rank(-1 * anl4_qfd1_azeps / close)`: S=-0.14, F=-0.05, T=3.0%, INFERIOR (TOP3000)
...
## Negated Direction
Best negated: `rank(-1 * ts_delta(anl4_qfd1_azeps, 5))` S=0.16, F=0.03, INFERIOR
...
|---|---|---|---|---|---|---|
| `rank(anl4_qfd1_azeps / close)` | TOP3000 | 0.89 | 0.74 | 11.3% | 60% | bull-only |
| `rank(anl4_qfd1_azeps)` | TOP3000 | 0.39 | 0.25 | 37.5% | 60% | bull-only |
| `rank(anl4_qfd1_azeps / close)` | TOP1000 | 0.35 | 0.21 | 22.6% | 60% | bull-only |
| `rank(ts_delta(anl4_qfd1_azeps, 5))` | TOP1000 | 0.42 | 0.09 | 7.7% | 60% | mixed |
| `rank(anl4_qfd1_azeps)` | TOP1000 | 0.15 | 0.06 | 38.1% | 60% | bull-only |
| `rank(anl4_qfd1_azeps / close)` | TOP500 | 0.12 | 0.05 | 30.7% | 60% | bull-only |
| `rank(ts_delta(anl4_qfd1_azeps, 5))` | TOP3000 | 0.24 | 0.03 | 8.7% | 80% | bull-only |
| `rank(anl4_qfd1_azeps)` | TOP500 | 0.08 | 0.02 | 36.0% | 60% | bull-only |
